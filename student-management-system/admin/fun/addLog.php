<?php
    ...
    $com="insert into student_log ( sid,class,type,reason,detail,logdate,addtime ) values(".$_POST["sid"].",'".$_POST["class"]."','".$_POST["type"]."','".$_POST["reason"]."','".$_POST["detail"]."','".$_POST["logdate"]."','". date('Y-m-d H:i:s')."' )" ;
